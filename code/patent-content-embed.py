...
# 目的是计算title+abstract=content的embedding
# 用于下一步的聚类分析
...
patent_path = "./data/patent_topic_content.csv"
...
def save_embeddings_to_csv(input_df, output_csv_path, tokenizer, model, device):
    with open(output_csv_path, mode='w', newline='', encoding='utf-8') as file:
        ...
        # 写入 CSV 表头
        writer.writerow(list(input_df.columns) + ['embedding'])
